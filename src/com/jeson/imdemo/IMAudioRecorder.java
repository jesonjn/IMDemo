...
public class IMAudioRecorder {
	...
	public static IMAudioRecorder getInstanse(Boolean recordingCompressed) {
		IMAudioRecorder result = null;

		if (recordingCompressed) {
			result = new IMAudioRecorder(false, AudioSource.MIC,
					sampleRates[3], AudioFormat.CHANNEL_CONFIGURATION_MONO,
					AudioFormat.ENCODING_PCM_16BIT);
		} else {
			result = new IMAudioRecorder(false, AudioSource.MIC,
					sampleRates[0], AudioFormat.CHANNEL_IN_STEREO,
					AudioFormat.ENCODING_PCM_16BIT);
			// int i=3;
			// do
			// {
			...
			// IMAudioRecorder.State.INITIALIZING));
		}
		return result;
	}
	...
	private AudioRecord.OnRecordPositionUpdateListener updateListener = new AudioRecord.OnRecordPositionUpdateListener() {
		public void onPeriodicNotification(AudioRecord recorder) {
			...
			try {
				...
				Log.e(IMAudioRecorder.class.getName(),
	 ...
	 */
	@SuppressWarnings("deprecation")
	public IMAudioRecorder(boolean uncompressed, int audioSource,
		...
		try {
			...
			if (rUncompressed) { // RECORDING_UNCOMPRESSED
				...
				if (bufferSize < AudioRecord.getMinBufferSize(sampleRate,
					...
					Log.w(IMAudioRecorder.class.getName(),
			...
			if (e.getMessage() != null) {
				Log.e(IMAudioRecorder.class.getName(), e.getMessage());
			} else {
				Log.e(IMAudioRecorder.class.getName(),
